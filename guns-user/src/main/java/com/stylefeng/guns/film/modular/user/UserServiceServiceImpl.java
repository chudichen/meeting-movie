...
import com.stylefeng.guns.film.common.persistence.dao.UserTMapper;
import com.stylefeng.guns.film.common.persistence.model.UserT;
...
public class UserServiceServiceImpl implements UserServiceApi {
    ...
    @Autowired
    public UserServiceServiceImpl(UserTMapper userTMapper) {
